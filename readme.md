...
Olá! Sou **Leonardo Taborda de Oliveira**, tenho 19 anos e sou Desenvolvedor Front-End apaixonado por criar experiências digitais modernas e impactantes. Atualmente atuo como **Meio Oficial em Soluções Digitais na Bosch Campinas**, e venho de uma trajetória sólida como **Aprendiz de Soluções Digitais**, onde desenvolvi bases sólidas em UI/UX e integração de sistemas.

### 🎯 O que me motiva:
- Desenvolver interfaces interativas e acessíveis
- Aprender novas stacks e frameworks
- Pensar soluções com foco em usabilidade e performance
- Criar projetos com um visual moderno e clean
